...
def record_invoice(invoice_file: TextIO,
    ...
    :param last_line_ptr: The position of start of last line in file.This will be obtained by previous call to `record_invoice`
    :return :the position of start of last in file can be used in subsequent calls to `record_invoice`
    """
    last_line_ptr = 0
